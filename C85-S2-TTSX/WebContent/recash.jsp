...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form id="app" name=alipayment action=payMoney.do method=post
			target="_blank">
		...
		<form name=traderefund action=Recash.do method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		axios({
			...
			document.getElementById("WIDTRout_trade_no").value=res.data[0].ordernum;
			//document.getElementById("WIDTRtrade_no").value = res.data[0].ordernum;
			document.getElementById("WIDTRrefund_amount").value = res.data[0].orderprices;
			document.getElementById("WIDTRrefund_reason").value = "未收到货";
			//document.getElementById("WIDTRout_request_no").value =res.data[0].ordernum;
		});
